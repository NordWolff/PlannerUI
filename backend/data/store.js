  ...
  store.tickets.push(
    {
      ...
      assigneeId: miladId, projectId: project1Id, boardId, sprintId, teamId: team1Id,
      checklist: [
    ...
    },
    {
      ...
      assigneeId: thomasWolffId, projectId: project1Id, boardId, sprintId, teamId: team1Id,
      checklist: [
    ...
    },
    {
      ...
      assigneeId: mircoId, projectId: project1Id, boardId, sprintId, teamId: team1Id,
    ...
    },
    {
      ...
      assigneeId: cindyId, projectId: project2Id, boardId, sprintId, teamId: team2Id,
      checklist: [
    ...
    },
    {
      ...
      assigneeId: null, projectId: project3Id, boardId: null, sprintId: null, teamId: team1Id,
      checklist: [], dependencies: [], comments: [], chatRefs: [], history: [],
      createdAt: now, updatedAt: now,
    },
    {
      ...
      assigneeId: torstenKloseId, projectId: project1Id, boardId, sprintId, teamId: team4Id,
      checklist: [
    ...
    },
    {
      ...
      assigneeId: lisaId, projectId: project2Id, boardId, sprintId, teamId: team2Id,
      checklist: [
    ...
    },
    {
      ...
      assigneeId: kevinId, projectId: project3Id, boardId: null, sprintId: null, teamId: team4Id,
      checklist: [], dependencies: [], comments: [], chatRefs: [], history: [],
      createdAt: now, updatedAt: now,
    },
  );
