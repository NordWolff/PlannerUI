      ...
      <section v-if="ownedPlanners.length > 0" class="mb-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          >
            ...
            <div class="p-5">
              <!-- Aktionen -->
              <div class="absolute top-4 right-3 flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity" @click.stop>
                <button @click="openEdit(planner)" class="p-1.5 text-gray-400 hover:text-primary dark:hover:text-primary-dark hover:bg-primary/10 rounded-md transition-colors" title="Bearbeiten">
                  <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                  </svg>
                </button>
                <button @click="confirmDelete(planner)" class="p-1.5 text-gray-400 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-md transition-colors" title="Löschen">
                  <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div class="flex items-center gap-2 mb-3">
                ...
                <span v-if="planner.ticketPrefix" class="text-xs font-mono text-gray-400 dark:text-gray-500 ml-auto pr-8">{{ planner.ticketPrefix }}-*</span>
              </div>
            ...
            <div class="p-5">
              <div class="flex items-center gap-2 mb-3">
                ...
                <button
                  ...
                  :class="isFavorite(planner.id) ? 'text-amber-400' : 'text-gray-300 dark:text-gray-600 opacity-0 group-hover:opacity-100 hover:text-amber-400'"
                >
