  ...
  <div class="space-y-4">
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
      ...
      <button @click="router.push(`/planner/${route.params.plannerId}/gantt`)"
        class="flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-medium border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-primary-light dark:hover:bg-primary-active/20 hover:text-primary-hover dark:hover:text-primary-dark-hover hover:border-primary-dark transition-colors">
